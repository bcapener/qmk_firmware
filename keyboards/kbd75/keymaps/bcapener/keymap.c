...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT(
    ...
    KC_LCTL,         KC_LGUI,  KC_LALT,                      MO(1),   KC_ENT,   KC_SPC,                        KC_RALT,  MO(1),    KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT
  ),
  ...
  [1] = LAYOUT(
    ...
    _______,  _______,  _______,  _______,  BL_DEC,   BL_TOGG,  BL_INC,   BL_STEP,  _______,  _______,  _______,  _______,  KC_MS_BTN1,               KC_MS_UP,    KC_MS_BTN2,
