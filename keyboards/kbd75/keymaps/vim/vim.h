...
vim_queue_t VIM_QUEUE = {0};
// vim_queue_t VIM_QUEUE = (vim_queue_t){
//   .event = TICK,
//   .keycode = KC_NO,
//   };
// const vim_queue_t VIM_QUEUE = (vim_queue_t){
//   .event = (keyevent_t){
//     .key = (keypos_t){
//       .row = 255,
//       .col = 255
...
void VIM_LEADER(uint16_t keycode) {
  VIM_QUEUE.keycode = keycode;
  VIM_QUEUE.event = TICK;
  switch(keycode) {
 ...
 * @param keycode
 */
void VIM_LEADER2(uint16_t keycode, keyevent_t event) {
  VIM_QUEUE.keycode = keycode;
  VIM_QUEUE.event = event;
  switch(keycode) {
    case VIM_C: print("\e[32mc\e[0m"); break;
    case VIM_CI: print("\e[32mi\e[0m"); break;
    case VIM_D: print("\e[32md\e[0m"); break;
